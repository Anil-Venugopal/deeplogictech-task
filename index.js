...
app.get("/",function(req,res){
	res.send('<html><p>Please click below link <br> <a href="https://latest5news.herokuapp.com/latestNews">https://latest5news.herokuapp.com/latestNews</a></br> to display latest 5 Stories from times.com</p></html>')
})
